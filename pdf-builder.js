// PDF BUILDER — Atelier B1: Objektstellung & Pronomen-Reihenfolge
(function () {
    ...
    function buildCast() {
        return `<div class="cast-banner">
            <h4>👋 Cast „Annettes Deutschkurs" — Atelier B1: Objektstellung & Pronomen-Reihenfolge</h4>
            <div class="cast-grid">
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Objektstellung & Pronomen-Reihenfolge</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillInBlock('Übung 1 — 2 substantive (Dativ vor Akkusativ) 📦', 'Wem? (Dativ) primul, apoi Was? (Akkusativ): dem Kind den Ball.', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += fillInBlock('Übung 2 — substantiv + pronume (pronomen zuerst) 🔤', 'Un pronume vine MEREU înaintea substantivului (indiferent de caz): es dem Kind / ihm den Ball.', ex2Data);
        }
        ...
        let html = `<h1 class="chapter new-section">🔁 4. Verbele atelierului — Präsens · Präteritum · Perfekt</h1>
            <div class="andreea-note">
                <div class="andreea-note-content">
                    ...
                    <div>Toate cele 6 verbe cer Dativ (persoana = Wem?) + Akkusativ (lucrul = Was?): geben-TARE (vedeta), schenken, zeigen, bringen-neregulat (brachte/gebracht), erklären și schicken. Cele trei reguli de ordine: dem Kind den Ball · es dem Kind · es ihm. Toate verificate pe PONS. Präteritum = imperfect.</div>
                </div>
            </div>`;
    ...
    function buildSolutions() {
        ...
        if (typeof ex1Data !== 'undefined') html += solFill('Übung 1 — 2 substantive (Dativ vor Akkusativ)', ex1Data);
        if (typeof ex2Data !== 'undefined') html += solFill('Übung 2 — substantiv + pronume (pronomen zuerst)', ex2Data);
        if (typeof ex3Data !== 'undefined') html += solFill('Übung 3 — 2 pronume (Akkusativ vor Dativ = es ihm)', ex3Data);
