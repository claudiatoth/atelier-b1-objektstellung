    ...
    ex1Data.forEach((it, i) => {
        html += `<div class="exercise-item">
            ...
            <div class="input-group">
                ...
                <input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" id="ex1-${it.id}" placeholder="Dativ + Akkusativ...">
            </div>
    ...
    ex2Data.forEach((it, i) => {
        html += `<div class="exercise-item">
            ...
            <div class="input-group">
                <label>${it.sentence}</label>
                <small style="color:#5A5147">💬 ${it.translation}</small>
                <input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" id="ex2-${it.id}" placeholder="pronume + substantiv...">
            </div>
    ...
    ex3Data.forEach((it, i) => {
        html += `<div class="exercise-item">
            ...
            <div class="input-group">
                <label>${it.sentence}</label>
                <small style="color:#5A5147">💬 ${it.translation}</small>
                <input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" id="ex3-${it.id}" placeholder="Akkusativ + Dativ...">
            </div>
